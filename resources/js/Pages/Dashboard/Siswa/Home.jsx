    ...
    return (
        <Sidebar active={'siswa'}>
            ...
            <div className='text-base font-semibold'>
                ...
                <Link href='/dashboard/siswa/create' className='bg-purple-700 md:rounded-md md:text-base text-xs rounded-sm px-2 py-[3px] md:px-3 md:py-1 text-white inline float-right'>Tambah Data +</Link>
            </div>
                        ...
                        {record?.map((row, index) => (
                            < tr
                                ...
                                <>
                                    ...
                                    <td className='p-3 whitespace-nowrap text-gray-700 text-sm border-2 border-gray-300'>{row?.nama}</td>
                                    <td className='p-3 whitespace-nowrap text-gray-700 text-sm border-2 border-gray-300'>{row?.nisn}</td>
                                    <td className='p-3 whitespace-nowrap text-gray-700 text-sm border-2 border-gray-300'>{row?.nis}</td>
                                    <td className='p-3 whitespace-nowrap text-gray-700 text-sm border-2 border-gray-300'>{row?.kelas?.nama_kelas}</td>
                                    <td className='p-3 whitespace-nowrap text-gray-700 text-sm border-2 border-gray-300'>{row?.alamat}</td>
                                    <td className='p-3 whitespace-nowrap text-gray-700 text-sm border-2 border-gray-300'>{row?.no_telp}</td>
                                    ...
                                    <td className='p-3 whitespace-nowrap text-gray-700 text-sm border-2 border-gray-300'>
                                        <Link
                                            href={`/dashboard/siswa/${row?.id}/edit`}
                ...
                {record?.map((row, index) => (
                    <div key={index} className='flex flex-row odd:bg-gray-100 p-2 rounded-md'>
                        ...
                        <ul className='inline-block '>
                            ...
                            <li className='mb-1 border-b-2'>{row?.nama}</li>
                            <li className='mb-1 border-b-2'>{row?.nisn}</li>
                            <li className='mb-1 border-b-2'>{row?.nis}</li>
                            <li className='mb-1 border-b-2'>{row?.kelas?.nama_kelas}</li>
                            <li className='mb-1 border-b-2'>{row?.alamat}</li>
                            <li className='mb-1 border-b-2'>{row?.no_telp}</li>
