    ...
    return (
        <Sidebar active={'petugas'}>
            ...
            <div className='text-base font-semibold'>
                ...
                <Link href='/dashboard/petugas/create' className='bg-purple-700 md:rounded-md md:text-base text-xs rounded-sm px-2 py-[3px] md:px-3 md:py-1 text-white inline float-right'>Tambah Data +</Link>
            </div>
                        ...
                        {record?.map((row, index) => (
                            < tr
                                ...
                                <>
                                    ...
                                    <td className='p-3 whitespace-nowrap text-gray-700 text-sm border-2 border-gray-300'>{row?.username}</td>
                                    <td className='p-3 whitespace-nowrap text-gray-700 text-sm border-2 border-gray-300'>{row?.nama_pengguna}</td>
                                    ...
                                    <td className='p-3 whitespace-nowrap text-gray-700 text-sm border-2 border-gray-300'>
                                        <Link
                                            href={`/dashboard/petugas/${row?.id}/edit`}
                ...
                {record?.map((row, index) => (
                    <div key={index} className='flex flex-row odd:bg-gray-100 p-2 rounded-md'>
                        ...
                        <ul className='inline-block '>
                            ...
                            <li className='mb-1 border-b-2'>{row?.username}</li>
                            <li className='mb-1 border-b-2'>{row?.nama_pengguna}</li>
                            <li className='mb-1 border-b-2'>{row?.level}</li>
                            <li className='my-2'>
                                <button
                                    onClick={() => handleDelete(row?.id)}
