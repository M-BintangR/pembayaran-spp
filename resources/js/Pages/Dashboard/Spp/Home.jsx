    ...
    return (
        <Sidebar active={'spp'}>
            ...
            <div className='text-base font-semibold'>
                ...
                <Link href='/dashboard/spp/create' className='bg-purple-700 md:rounded-md md:text-base text-xs rounded-sm px-2 py-[3px] md:px-3 md:py-1 text-white inline float-right'>Tambah Data +</Link>
            </div>
                            ...
                            < tr
                                ...
                                <>
                                    ...
                                    <td className='p-3 whitespace-nowrap text-gray-700 text-sm border-2 border-gray-300'>
                                        <Link
                                            href={`/dashboard/spp/${row?.id}/edit`}
